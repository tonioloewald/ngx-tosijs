import { TosiSignal, TosiSignalOptions } from "./tosi-signal";
/**
...
export declare const typedTosi: <S extends object>() => {
    tosiSignal: <P extends TosiPath<S> & string>(path: P, options?: TosiSignalOptions<TosiPathValue<S, P>>) => TosiSignal<TosiPathValue<S, P>>;
};
export {};
